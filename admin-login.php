...
{
    $sql = "select  school_name,school_address from school_info where school_id='{$_POST['school_id']}'";
    $run = mysqli_query($con,$sql);
    $run = mysqli_fetch_assoc($run);
    if(!empty($run))
    {
        $_SESSION['SCHOOL_ID'] = $_POST['school_id'];
        $_SESSION['SCHOOL_NAME'] = $run['school_name'];
        $_SESSION['SCHOOL_ADDRESS']=$run['school_address'];
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid Username is required: ST1000">
						<input class="input100" type="text" name="school_id" placeholder="Username">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="school_id" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
