            ...
            <div class="row">
						...
						<div class="col-xl-3 col-sm-6 col-12 d-flex">
							<div class="card bg-five w-100">
								<div class="card-body bg-gradient-danger"style="border-radius:30px 0px">
						...
						<div class="col-xl-3 col-sm-6 col-12 d-flex">
							<div class="card bg-six w-100">
								<div class="card-body bg-gradient-info"style="border-radius:30px 0px">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-icon">
						...
						<div class="col-xl-3 col-sm-6 col-12 d-flex">
							<div class="card bg-seven w-100">
								<div class="card-body bg-gradient-success"style="border-radius:30px 0px">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										<div class="db-icon">
