...
?>
        ...
        <div class="main-panel">
          <div class="content-wrapper">
            ...
            <div class="row">
							<div class="col-sm-12">
								<h3 class="page-title"><span style="font-size :1.5rem;">Welcome Parent !!</span></h3>
								<h4>Student name:<strong><?php echo $student_name;?></strong></h4>
								<h6 style="font-size :1.0rem;">Class:<strong> <?php echo $run['class'].'-'.$run['section'];?></strong></h6>
                                </h3>
								<ul class="breadcrumb">
									<li class="breadcrumb-item"><a style="font-size :1.2rem"; href="">Dashboard</a></li>
									<li class="breadcrumb-item active" style="font-size :1.2rem";>Student Dashboard</li>
								</ul>
							</div>
						</div>
					</div>
							...
							<div class="card bg-nine w-100">
								<div class="card-body"><a href="student-view-all-academic-rank.php?ra=<?php echo $rank; ?>">
									<div class="db-widgets d-flex justify-content-between align-items-center">
										...
										<div class="db-info">
											<h3><?php echo $rank;?></h3>
											<h6 style="font-size:1.2rem";>Academic Rank</h6>
										</div>										
									</div>
								</div></a>
							</div>
         ...
         <br>
							...
							<div class="row">
								...
								<div class="col-12 col-lg-12 col-xl-4 d-flex">
									<div class="card flex-fill">
										<div class="card-header">
											<h5 class="card-title">Current Academic Year 2021-2022</h5>
										</div>
										<div class="card-body">
