...
{
    $sql = "select school_id ,student_id,class_id,student_name from student where student_id='{$_POST['student_id']}' ";
			...
			<div class="wrap-login100">
				...
				<form class="login100-form validate-form" method="post">
					...
					<div class="wrap-input100 validate-input" data-validate = "Valid Username is required: ST1000">
						<input class="input100" type="text" name="student_id" placeholder="Username">
					...
					<div class="wrap-input100 validate-input" data-validate = "Password is required">
						<input class="input100" type="password" name="student_id" placeholder="Password">
						<span class="focus-input100"></span>
						<span class="symbol-input100">
