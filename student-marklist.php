			...
			<!-- Page Wrapper -->
                ...
                <div class="content-wrapper">
					...
					<div class="page-header">
						<div class="row">
							<div class="col">
              <h3 class="page-title"style="font-size:1.5rem">Mark List</h3>
							
								<ul class="breadcrumb">

									<li class="breadcrumb-item"style="font-size:1rem"><a href="student-dashboard.php">Dashboard</a></li>
									<li class="breadcrumb-item active"style="font-size:1rem">Mark List</li>
								</ul>
							</div>
						</div>
					</div>
